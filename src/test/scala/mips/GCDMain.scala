...
//  * {{{
//  * test:runMain mips.GCDMain
//  * }}}
//  * To see all command line options use:
//  * {{{
//  * test:runMain mips.GCDMain --help
//  * }}}
//  * To run with verilator:
//  * {{{
//  * test:runMain mips.GCDMain --backend-name verilator
//  * }}}
//  * To run with verilator from your terminal shell use:
//  * {{{
//  * sbt 'test:runMain mips.GCDMain --backend-name verilator'
//  * }}}
//  */
//object GCDMain extends App {
//  iotesters.Driver.execute(args, () => new MIPS) {
...
//  * To run from sbt
//  * {{{
//  * test:runMain mips.GCDRepl
//  * }}}
//  * To run from sbt and see the half a zillion options try
//  * {{{
//  * test:runMain mips.GCDRepl --help
//  * }}}
//  */
//object GCDRepl extends App {
//  iotesters.Driver.executeFirrtlRepl(args, () => new MIPS)
//}

...
//
//class GCDUnitTester(c: MIPS) extends PeekPokeTester(c) {
//  /**
...
//  * From within sbt use:
//  * {{{
//  * testOnly mips.GCDTester
//  * }}}
//  * From a terminal shell use:
//  * {{{
//  * sbt 'testOnly mips.GCDTester'
//  * }}}
//  */
//class MIPSTester extends ChiselFlatSpec {
...
//    iotesters.Driver.execute(Array(), () => new MIPS) {
//      c => new GCDUnitTester(c)
//    } should be (true)
//  }
//
...
//      iotesters.Driver.execute(Array("--backend-name", "verilator"), () => new MIPS) {
//        c => new GCDUnitTester(c)
//      } should be(true)
//    }
//  }
...
//    iotesters.Driver.execute(Array("--is-verbose"), () => new MIPS) {
//      c => new GCDUnitTester(c)
//    } should be(true)
//  }
//
